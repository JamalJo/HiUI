...
//        goods=findViewById(R.id.img_move);
        mRelativeLayout = findViewById(R.id.rl);
        mPlusImage = findViewById(R.id.img_plus);
        mDestinationView = findViewById(R.id.view_destnation);
...
//      一、创造出执行动画的主题---imageview
        ...
        goods.setImageDrawable(ContextCompat.getDrawable(this, R.drawable.flower));
...
//        二、计算动画开始/结束点的坐标的准备工作
        ...
        mPlusImage.getLocationInWindow(startLoc);

        //得到购物车图片的坐标(用于计算动画结束后的坐标)
        int endLoc[] = new int[2];
        mDestinationView.getLocationInWindow(endLoc);


//        三、正式开始计算动画开始/结束的坐标
        //开始掉落的商品的起始点：商品起始点-父布局起始点+该商品图片的一半
        float startX = startLoc[0] - parentLocation[0] + mPlusImage.getWidth() / 2;
        float startY = startLoc[1] - parentLocation[1] + mPlusImage.getHeight() / 2;
